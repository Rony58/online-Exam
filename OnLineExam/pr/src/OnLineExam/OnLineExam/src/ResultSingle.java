...
public class ResultSingle extends javax.swing.JFrame {
    Connection con;
    Statement st;
    ...
    public ResultSingle() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            ...
            {
                JOptionPane.showMessageDialog(this,"Please Enter Roll No.","Error",0);
            }
            else
            {
           ...
           int marks=Integer.parseInt(rs.getString(4));
                ...
                JOptionPane.showMessageDialog(this,"Please Enter valid Roll No.","Error",0);
            }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ResultSingle.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
                    Logger.getLogger(ResultSingle.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
