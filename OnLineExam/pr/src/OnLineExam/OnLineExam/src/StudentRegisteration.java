...
public class StudentRegisteration extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            try {
            	 cs = con.prepareStatement("Select * from student_detail");
            	...
            	if(f==1)
            	{
            		JOptionPane.showMessageDialog(this,"user already registred");
            	}
            	else
            	{
                Object obj1;
                ...
                cs.setString(7, obj3.toString());
                cs.setString(6, jPasswordField1.getText());
                //System.out.println("what's the error");
                cs.executeUpdate();
